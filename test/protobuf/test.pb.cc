...
namespace fixbug {
constexpr ResultCode_TestEntry_DoNotUse::ResultCode_TestEntry_DoNotUse(
    ::_pbi::ConstantInitialized){}
struct ResultCode_TestEntry_DoNotUseDefaultTypeInternal {
  constexpr ResultCode_TestEntry_DoNotUseDefaultTypeInternal()
      : _instance(::_pbi::ConstantInitialized{}) {}
  ~ResultCode_TestEntry_DoNotUseDefaultTypeInternal() {}
  union {
    ResultCode_TestEntry_DoNotUse _instance;
  };
};
PROTOBUF_ATTRIBUTE_NO_DESTROY PROTOBUF_CONSTINIT PROTOBUF_ATTRIBUTE_INIT_PRIORITY1 ResultCode_TestEntry_DoNotUseDefaultTypeInternal _ResultCode_TestEntry_DoNotUse_default_instance_;
constexpr ResultCode::ResultCode(
    ::_pbi::ConstantInitialized)
  : test_(::PROTOBUF_NAMESPACE_ID::internal::ConstantInitialized{})
...
const uint32_t TableStruct_test_2eproto::offsets[] PROTOBUF_SECTION_VARIABLE(protodesc_cold) = {
  PROTOBUF_FIELD_OFFSET(::fixbug::ResultCode_TestEntry_DoNotUse, _has_bits_),
  PROTOBUF_FIELD_OFFSET(::fixbug::ResultCode_TestEntry_DoNotUse, _internal_metadata_),
  ~0u,  // no _extensions_
  ~0u,  // no _oneof_case_
  ~0u,  // no _weak_field_map_
  ~0u,  // no _inlined_string_donated_
  PROTOBUF_FIELD_OFFSET(::fixbug::ResultCode_TestEntry_DoNotUse, key_),
  PROTOBUF_FIELD_OFFSET(::fixbug::ResultCode_TestEntry_DoNotUse, value_),
  0,
  1,
  ~0u,  // no _has_bits_
  ...
  PROTOBUF_FIELD_OFFSET(::fixbug::ResultCode, test_),
  ~0u,  // no _has_bits_
  ...
  PROTOBUF_FIELD_OFFSET(::fixbug::GetFriendListsResponse, frinend_list_),
};
static const ::_pbi::MigrationSchema schemas[] PROTOBUF_SECTION_VARIABLE(protodesc_cold) = {
  { 0, 8, -1, sizeof(::fixbug::ResultCode_TestEntry_DoNotUse)},
  { 10, -1, -1, sizeof(::fixbug::ResultCode)},
  { 19, -1, -1, sizeof(::fixbug::LoginRequest)},
  { 27, -1, -1, sizeof(::fixbug::LoginResponse)},
  { 35, -1, -1, sizeof(::fixbug::User)},
  { 44, -1, -1, sizeof(::fixbug::GetFriendListsRequest)},
  { 51, -1, -1, sizeof(::fixbug::GetFriendListsResponse)},
};

static const ::_pb::Message* const file_default_instances[] = {
  &::fixbug::_ResultCode_TestEntry_DoNotUse_default_instance_._instance,
...
const char descriptor_table_protodef_test_2eproto[] PROTOBUF_SECTION_VARIABLE(protodesc_cold) =
  "\n\ntest.proto\022\006fixbug\"\206\001\n\nResultCode\022\017\n\007e"
  "rrcode\030\001 \001(\005\022\016\n\006errmsg\030\002 \001(\014\022*\n\004test\030\003 \003"
  "(\0132\034.fixbug.ResultCode.TestEntry\032+\n\tTest"
  ...
  "\030\001 \001(\0132\022.fixbug.ResultCode\022\"\n\014frinend_li"
  "st\030\002 \003(\0132\014.fixbug.User2\227\001\n\016UserServiceRp"
  "c\0224\n\005Login\022\024.fixbug.LoginRequest\032\025.fixbu"
  "g.LoginResponse\022O\n\016GetFriendLists\022\035.fixb"
  "ug.GetFriendListsRequest\032\036.fixbug.GetFri"
  "endListsResponseB\003\200\001\001b\006proto3"
  ;
static ::_pbi::once_flag descriptor_table_test_2eproto_once;
const ::_pbi::DescriptorTable descriptor_table_test_2eproto = {
    false, false, 669, descriptor_table_protodef_test_2eproto,
    "test.proto",
...
ResultCode_TestEntry_DoNotUse::ResultCode_TestEntry_DoNotUse() {}
ResultCode_TestEntry_DoNotUse::ResultCode_TestEntry_DoNotUse(::PROTOBUF_NAMESPACE_ID::Arena* arena)
    : SuperType(arena) {}
void ResultCode_TestEntry_DoNotUse::MergeFrom(const ResultCode_TestEntry_DoNotUse& other) {
  MergeFromInternal(other);
}
::PROTOBUF_NAMESPACE_ID::Metadata ResultCode_TestEntry_DoNotUse::GetMetadata() const {
...
uint8_t* ResultCode::_InternalSerialize(
  ...
  if (!this->_internal_test().empty()) {
    ...
    using WireHelper = ResultCode_TestEntry_DoNotUse::Funcs;
    ...
    auto check_utf8 = [](const MapType::value_type& entry) {
      ...
      ::PROTOBUF_NAMESPACE_ID::internal::WireFormatLite::VerifyUtf8String(
        ...
        "fixbug.ResultCode.TestEntry.value");
    };
...
// @@protoc_insertion_point(message_byte_size_start:fixbug.ResultCode)
  ...
  for (::PROTOBUF_NAMESPACE_ID::Map< int32_t, std::string >::const_iterator
    ...
    total_size += ResultCode_TestEntry_DoNotUse::Funcs::ByteSizeLong(it->first, it->second);
  }
...
GetFriendListsResponse::GetFriendListsResponse(const GetFriendListsResponse& from)
  : ::PROTOBUF_NAMESPACE_ID::Message(),
      frinend_list_(from.frinend_list_) {
  _internal_metadata_.MergeFrom<::PROTOBUF_NAMESPACE_ID::UnknownFieldSet>(from._internal_metadata_);
  if (from._internal_has_result()) {
    result_ = new ::fixbug::ResultCode(*from.result_);
  } else {
    ...
    switch (tag >> 3) {
      ...
      case 2:
        if (PROTOBUF_PREDICT_TRUE(static_cast<uint8_t>(tag) == 18)) {
          ...
          do {
            ptr += 1;
            ptr = ctx->ParseMessage(_internal_add_frinend_list(), ptr);
            CHK_(ptr);
            if (!ctx->DataAvailable(ptr)) break;
...
uint8_t* GetFriendListsResponse::_InternalSerialize(
  ...
  // repeated .fixbug.User frinend_list = 2;
  for (unsigned i = 0,
      n = static_cast<unsigned>(this->_internal_frinend_list_size()); i < n; i++) {
    const auto& repfield = this->_internal_frinend_list(i);
    target = ::PROTOBUF_NAMESPACE_ID::internal::WireFormatLite::
...
// @@protoc_insertion_point(message_byte_size_start:fixbug.GetFriendListsResponse)
  ...
  // repeated .fixbug.User frinend_list = 2;
  total_size += 1UL * this->_internal_frinend_list_size();
  for (const auto& msg : this->frinend_list_) {
    total_size +=
...
// @@protoc_insertion_point(class_specific_merge_from_start:fixbug.GetFriendListsResponse)
  ...
  frinend_list_.MergeFrom(from.frinend_list_);
  if (from._internal_has_result()) {
    _internal_mutable_result()->::fixbug::ResultCode::MergeFrom(from._internal_result());
  }
  _internal_metadata_.MergeFrom<::PROTOBUF_NAMESPACE_ID::UnknownFieldSet>(from._internal_metadata_);
...
void GetFriendListsResponse::InternalSwap(GetFriendListsResponse* other) {
  using std::swap;
  _internal_metadata_.InternalSwap(&other->_internal_metadata_);
  frinend_list_.InternalSwap(&other->frinend_list_);
...
template<> PROTOBUF_NOINLINE ::fixbug::ResultCode_TestEntry_DoNotUse*
Arena::CreateMaybeMessage< ::fixbug::ResultCode_TestEntry_DoNotUse >(Arena* arena) {
  return Arena::CreateMessageInternal< ::fixbug::ResultCode_TestEntry_DoNotUse >(arena);
}
